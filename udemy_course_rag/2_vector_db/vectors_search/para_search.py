...
class LongTextVectorSearch:
    ...
    def search_similar_texts(self, query_text, top_k=5):
        ...
        for index in top_indices:
            ...
            chunk_content = self.all_chunks[index]
            results.append((chunk_content, chunk_id, similarity))
...
Risk Assessment: Evaluate investment similarities and portfolio diversification."""  # ~650 words
    ...
    for text, chunk_id, similarity in results:
        print(f"{chunk_id}: Similarity = {similarity:.4f} - Content: {text}")